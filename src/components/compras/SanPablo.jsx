...
// Qué se puede hacer dentro del taller. Los colores son los mismos que en
// Berdina: las dos pantallas son la misma cosa y lo que cambia de taller lo
// dice el título, no el color de las tarjetas.
const OPCIONES = [
  {
    id: 'pedidos',
    titulo: 'Pedidos',
    ...
    destino: '/compras/sanpablo/pedidos',
    colores: {
  ...
  },
  {
    ...
    destino: '/compras/sanpablo/pendientes',
    colores: {
  ...
  {
    id: 'stock',
    titulo: 'Stock San Pablo',
    subtitulo: 'Repuestos disponibles en el taller de San Pablo',
    icono: 'bi bi-box-seam-fill',
    destino: '/compras/sanpablo/stock',
    colores: {
