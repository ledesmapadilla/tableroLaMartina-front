...
const tarjetas = [
  { titulo: 'Pedidos',    icono: 'bi-cart3',           ruta: '/compras/analista/pedidos',    color: 'linear-gradient(135deg, #7a1828, #4a0812)' },
  { titulo: 'Pendientes', icono: 'bi-hourglass-split', ruta: '/compras/analista/pendientes', color: 'linear-gradient(135deg, #316650, #1a3326)' },
  { titulo: 'Stock',      icono: 'bi-box-seam',        ruta: '/compras/analista/stock',      color: 'linear-gradient(135deg, #5a5a5a, #2a2a2a)' },
]
