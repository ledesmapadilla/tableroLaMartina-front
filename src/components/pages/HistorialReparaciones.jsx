...
const CATEGORIA_COLORES = {
  ...
  "Tren Delantero": { bg: "#cffafe", text: "#155e75", border: "#22d3ee" },
...
function HistorialReparaciones() {
  ...
  const sinEditar = !puede("camionetas.historial", "editar");
  ...
  const trabajosFiltrados = useMemo(() => {
    return trabajos.filter((t) => {
      ...
      if (busqueda.trim()) {
        ...
        // Estas tres se usaban sin estar definidas: escribir en el buscador
        // rompía la pantalla.
    ...
    >
      ...
      <Container fluid className="px-4 py-3" style={{ maxWidth: "1300px", margin: "0 auto" }}>
        ...
        {/* Tabla con el formato común del proyecto (clase .tabla-informe), el
            mismo que la Planilla General de Reparaciones: encabezado verde,
            letra chica y filas finas. */}
        <div
