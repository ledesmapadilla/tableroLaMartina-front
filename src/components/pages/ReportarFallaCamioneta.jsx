...
function ReportarFallaCamioneta() {
    ...
    fetch(`/api/camionetas/${camionetaId}`)
      ...
      .then((data) => {
        if (data) {
          ...
          setFormData((prev) => ({
            ...prev,
            responsable: prev.responsable || data.responsable || "",
            maquinaParada: false, // Por defecto siempre en servicio
          }));
        }
      })
      .catch(() => {});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          navigate(`/camionetas/services/reparaciones/${camionetaId}/tareas`, {
            state: { patente, marca, responsable: formData.responsable },
          });
        }, 1400);
      } else {
        Swal.fire({
      ...
      <Container className="py-2" style={{ maxWidth: "680px" }}>
        <Card className="shadow-sm rounded-4 px-4 py-3 bg-white" style={{ border: "1px solid #cbd5e1" }}>
          ...
          <Form onSubmit={handleSubmit}>
            {/* Fila Superior: Fecha a la izquierda y Camioneta Parada a la derecha */}
            <div className="d-flex align-items-center justify-content-between mb-2 pb-2" style={{ borderBottom: "1px solid #f1f5f9" }}>
              ...
              >
                <div className="d-flex align-items-center gap-2" style={{ fontSize: "0.84rem" }}>
                  ...
                  ></i>
                  <span className="text-dark" style={{ fontSize: "0.82rem" }}>Camioneta parada</span>
                </div>
                <Form.Check
                  type="switch"
                  id="parada-switch"
              ...
              <Col sm={6}>
                <Form.Group>
                  ...
                  >
                    ...
                    <option value="Chapa / Carrocería">Chapa / Carrocería</option>
...
export default ReportarFallaCamioneta;
