      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "0.4rem 0.8rem", overflow: "hidden" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(8, 1fr)", gridAutoRows: "1fr", gap: "0.3rem", flex: 1, maxHeight: "70vh", width: "80%" }}>
          {MESES.map((mes, i) => {
            ...
            const clBg = info === null ? "rgba(74, 111, 165, 0.65)" : info.pendientes === 0 ? "rgba(82, 115, 90, 0.65)" : "rgba(220, 20, 20, 0.7)";
            const clBgHover = info === null ? "rgba(74, 111, 165, 0.85)" : info.pendientes === 0 ? "rgba(82, 115, 90, 0.85)" : "rgba(220, 20, 20, 0.88)";
            return (
              <div key={mes} style={{ gridColumn: "span 2", backgroundColor: "rgba(74, 111, 165, 0.45)", borderRadius: "8px", boxShadow: "2px 2px 6px rgba(0,0,0,0.25)", border: "2px solid #000", display: "flex", overflow: "hidden", userSelect: "none", backdropFilter: "blur(4px)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", width: "52%" }}>
                  ...
                  {(() => {
                    ...
                    const svBg = kmSinRelevar === null ? "rgba(74, 111, 165, 0.65)" : kmSinRelevar === 0 ? "rgba(82, 115, 90, 0.65)" : "rgba(220, 20, 20, 0.7)";
                    const svBgHover = kmSinRelevar === null ? "rgba(74, 111, 165, 0.85)" : kmSinRelevar === 0 ? "rgba(82, 115, 90, 0.85)" : "rgba(220, 20, 20, 0.88)";
                    return (
                      <div
                        className="d-flex flex-column align-items-center justify-content-center text-black"
          ...
          {(() => {
            const bg = serviciosAtrasados === null ? "rgba(74, 111, 165, 0.65)" : serviciosAtrasados === 0 ? "rgba(82, 115, 90, 0.65)" : "rgba(220, 20, 20, 0.7)";
            const bgHover = serviciosAtrasados === null ? "rgba(74, 111, 165, 0.85)" : serviciosAtrasados === 0 ? "rgba(82, 115, 90, 0.85)" : "rgba(220, 20, 20, 0.88)";
            return (
              <div
                className="d-flex flex-column align-items-center justify-content-center text-black"
          ...
          {(() => {
            const bg = tareasPendientes === null ? "rgba(74, 111, 165, 0.65)" : tareasPendientes === 0 ? "rgba(82, 115, 90, 0.65)" : "rgba(220, 20, 20, 0.7)";
            const bgHover = tareasPendientes === null ? "rgba(74, 111, 165, 0.85)" : tareasPendientes === 0 ? "rgba(82, 115, 90, 0.85)" : "rgba(220, 20, 20, 0.88)";
            return (
              <div
                className="d-flex flex-column align-items-center justify-content-center text-black"
          ...
          {(() => {
            const bg = unidadesParadas === null ? "rgba(74, 111, 165, 0.65)" : unidadesParadas === 0 ? "rgba(82, 115, 90, 0.65)" : "rgba(220, 20, 20, 0.7)";
            const bgHover = unidadesParadas === null ? "rgba(74, 111, 165, 0.85)" : unidadesParadas === 0 ? "rgba(82, 115, 90, 0.85)" : "rgba(220, 20, 20, 0.88)";
            return (
              <div
                className="d-flex flex-column align-items-center justify-content-center text-black"
